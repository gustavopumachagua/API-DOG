  ...
  return (
    <>
      {!dogs ? (
        ...
        <>
          <section className="p-8 max-w-full mx-auto bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
            <div className="text-center">
              ...
              <p className="my-8 text-slate-700">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-indigo-900 underline active:text-orange-400"
                >
                  The Dog Api
                </a>
              </p>
              ...
              >
                <input
                  ...
                  className="py-2 px-4 rounded shadow w-full bg-white text-black placeholder-zinc-500"
                  value={text}
                  onChange={(e) => setText(e.target.value)}
                />
              </form>
              <Link to="/playdog">Play Dog</Link>
            </div>
